...
LOGOUT_REDIRECT_URL = '/'
LOGIN_REDIRECT_URL = '/'
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend' #to be removed in production



CSRF_TRUSTED_ORIGINS = ['https://8000-zuritrainin-team87zurif-js5jxzyieio.ws-eu54.gitpod.io']